...
- [python](https://caoyang7.github.io/2019/08/19/python-install-window/)
- [django](https://caoyang7.github.io/2019/11/23/django-note1/)
### 集成开发环境的搭建
- webstorm
- pycharm
- 安装参考[这里](https://caoyang7.github.io/2019/08/16/pycharm-install/),激活破解以及设置,可以在我的[github](https://github.com/caoyang7/jetbrains_settings)/[github](https://github.com/caoyang7/jetbrains_settings)中clone下来    
## 起步
...
## 项目的源码地址
github:[vue_django_project](https://github.com/caoyang7/vue_django_project)  
