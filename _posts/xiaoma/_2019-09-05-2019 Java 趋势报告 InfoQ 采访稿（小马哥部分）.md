...
> [曹阳（@mercyblitz）](https://caoyang7.gitee.io/about/)：
>
> | 创新者                    | 早期采用者  | 早期大众         | 晚期大众                     |
> | ------------------------- | ----------- | ---------------- | ---------------------------- |
...
[曹阳（@mercyblitz）](https://caoyang7.gitee.io/about/)，《Spring Boot 编程思想》作者、Apache Dubbo PMC 和 Spring-Cloud-Alibaba Architect