...
### 环境准备
首先我们需要python环境,它的安装可以参考:[python安装以及版本检测](https://caoyang7.github.io/2019/08/19/python-install-window/)

其次我们还需要安装一个python图形化的库PIL

PIL的安装,这里我们使用pip来进行安装,关于pip可以参考:[Python pip 安装与使用](https://caoyang7.github.io/2019/10/12/python-install-pip/)
...
这里小编推荐使用[pycharm](https://caoyang7.github.io/2019/09/26/jetbrains-pycharm-introduce/)进行安装

关于它的安装可以参考:[PyCharm的安装以及破解](https://caoyang7.github.io/2019/08/16/pycharm-install/)
### 源码参考
