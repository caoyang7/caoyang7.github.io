...
详情可参考:[Python实现一行代码推本地git到远程仓库](https://caoyang7.github.io/2019/09/08/python-auto-git-push/)
...
关于它的安装和使用可以参考:[python中文件变化监控-watchdog](https://caoyang7.github.io/2019/10/10/python-listen-dir/)
