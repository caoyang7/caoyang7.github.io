...
### 环境搭建
python3.7 环境:[python安装以及版本检测](https://caoyang7.gitee.io/2019/08/19/python-install-window/)

pycharm2019:[PyCharm的安装以及破解](https://caoyang7.gitee.io/2019/08/16/pycharm-install/)
...
](https://caoyang7.gitee.io/2019/10/12/python-install-pip/)和[pip配置](https://caoyang7.gitee.io/2019/11/20/pip-conf/)
